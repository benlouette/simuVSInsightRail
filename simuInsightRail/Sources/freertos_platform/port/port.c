...
void vPortEnableVFP(void) {
    // Original ARM-specific code to enable the FPU.
    __asm volatile (
    "  ldr.w r0, =0xE000ED88  \n" /* CAPCR, 0xE000ED88 */
        "  ldr r1, [r0]           \n" /* read CAPR */
...
#else
void vPortEnterCritical(void) {
    // Simulated version for non-ARM environment
    uxCriticalNesting++;
    // Memory barriers may not be needed or replaced by compiler intrinsics
}
#endif
/*-----------------------------------------------------------*/
...
#else
void vPortStartFirstTask(void) {
    // Implementation for non-ARM platforms or a stub
}
#endif
/*-----------------------------------------------------------*/
#if (configCOMPILER==configCOMPILER_ARM_KEIL)
...
void vPortPendSVHandler(void) {
    // Stub function or alternative implementation
    // Context switching is managed by the OS in PC environments
}
#endif
/*-----------------------------------------------------------*/
#if (configCOMPILER==configCOMPILER_ARM_KEIL)
...
//#else
//void vPortPendSVHandler_native(void) {
//    // Stub for non-ARM platforms
//}
//#endif
...
#else
void vPortPendSVHandler_native(void) {
    // This function might be left empty or implemented differently 
}

void  PendSV_Handler_jumper(void) {
    // This function might be left empty or implemented differently 
